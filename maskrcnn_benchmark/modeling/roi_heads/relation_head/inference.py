...
class PostProcessor(nn.Module):
    ...
    def forward(self, x, rel_pair_idxs, boxes):
        ...
        for i, (rel_logit, obj_logit, rel_pair_idx, box) in enumerate(zip(
            ...
            if(self.cfg.GLOBAL_SETTING.RELATION_PREDICTOR == "MotifsLike_Group50" or self.cfg.GLOBAL_SETTING.RELATION_PREDICTOR=="VCTree_Group50" or self.cfg.GLOBAL_SETTING.RELATION_PREDICTOR=="TransLike_Group50"):
