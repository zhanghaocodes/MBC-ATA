...
def get_dataset_statistics(cfg):
    ...
    data_statistics_name = ''.join(dataset_names) + '_statistics'   #原来的
    save_file = os.path.join(cfg.OUTPUT_DIR, "{}.cache".format(data_statistics_name))  #原来的
...
def make_data_loader(cfg, mode='train', is_distributed=False, start_iter=0):
    ...
    if is_train:
        ...
        shuffle = True  #  原来的
        #shuffle = False
        num_iters = cfg.SOLVER.MAX_ITER   #原来的  60000
        #num_iters = None
    else:
