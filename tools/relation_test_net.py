...
def main():
    ...
    parser.add_argument(
        "--config-file",
        default="/home/share/zhanghao/codes/Motif_Codebase/configs/zh_test.yaml",
        metavar="FILE",
    ...
    save_dir = "/home/share/zhanghao/data/image/datasets/output/Group/ablation/test/motifs/inferlog"
