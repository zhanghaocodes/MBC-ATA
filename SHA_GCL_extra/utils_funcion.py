...
#  下面是负类其他所有类别的bias
# class FrequencyBias_Group(nn.Module):
#     """
...
#         super(FrequencyBias_Group, self).__init__()
...
#         #         lines = lines + 1
#         value = max(predicate_all_list)
#         index_1 = predicate_all_list.index(value)
#         fg_matrix[:, :, 1] = old_matrix[:, :, index_1]
#         sum_tmp = torch.sum(old_matrix,-1)
#         sub_tmp = old_matrix[:, :, index_1]
#         fg_matrix[:, :, 0] =  torch.sub(sum_tmp,sub_tmp)
#
#
